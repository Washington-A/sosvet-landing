...
export const aboutBlocks: AboutBlock[] = [
    {
        ...
        content: 'O Dr. Neto, sócio-fundador e médico-veterinário, iniciou esta jornada em 2010 movido pelo sonho de oferecer qualidade, inovação e cuidado humanizado no atendimento de cães e gatos em Santa Helena. Com dedicação, amor pela medicina veterinária e compromisso com o bem-estar animal, o projeto cresceu — e assim nasceu a SOS Animal.',
    ...
    },
    {
        ...
        content: 'Ao longo dos anos, a busca por excelência fez a empresa evoluir. A SOS Animal tornou-se o Centro Veterinário S.O.S, agora com nova sede e estrutura ampliada, atendendo também as regiões de Maurilândia e Turvelândia. São mais de 30.000 atendimentos realizados, sempre guiados pelo cuidado, pela ética e pelo respeito à vida.',
